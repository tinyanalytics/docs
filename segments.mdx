...
<Steps>
  <Step title="Filter your dashboard">
    Add the filters that define your segment — for example, `country is US` and `device type is Mobile`. See [Filter your data](/filters).
  </Step>
...
<Columns cols={2}>
  ...
  <Card title="Behavioral cohorts" icon="users-rectangle" href="/cohorts">
