...
- A key inherits **its owner's access**: a request authenticates as the user who created the key, and is authorized by that user's organization membership and [team](/teams) access. A key never grants more than its owner has.
