---
title: "Identify Users API"
sidebarTitle: "Identify API"
description: "Attach a stable user ID and traits with POST /api/identify, then connect the visitor's recent anonymous events to that identified user."
icon: "user"
...
See [identify users](/user-identification-analytics) for the full browser API.
