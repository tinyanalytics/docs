...
When you call `/api/track` from your backend, add an [API key](/api-reference/api-authentication) so the event is attributed to the **visitor**, not your server:
