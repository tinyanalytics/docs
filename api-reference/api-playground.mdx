...
On narrow screens, scroll the workspace horizontally to reach each panel. Filter
controls wrap to keep entered values readable, and long paths leave the **Run**
button visible.
...
- **Check the request** before wiring the API into your app. **Run** uses your dashboard session; test the copied snippet with your API key separately.
...
To look up an endpoint's **path, method, and parameters** without signing in, use the **Endpoints** section of this reference instead—it documents 155 published endpoints across 30 groups.
