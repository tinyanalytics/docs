---
title: "Live Visitor Count Widget"
sidebarTitle: "Live-visitors widget"
...
<Columns cols={2}>
  ...
  <Card title="Install the tracker" icon="download" href="/install-tinyanalytics-tracking-script">
