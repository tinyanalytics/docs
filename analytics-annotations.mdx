...
description: "Add dated notes to site or organization charts so deployments, campaigns, and incidents explain the traffic spikes and dips beside them."
icon: "note-sticky"
---
...
<Columns cols={2}>
  ...
  <Card title="Export" icon="file-arrow-down" href="/export-analytics-data">
