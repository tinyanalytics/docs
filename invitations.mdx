---
title: "Invitations"
description: "Invite people to your tinyanalytics organization by email. Send an invitation with a role, the invitee accepts through a link, and pending invitations can be revoked anytime."
icon: "envelope"
---
...
<Steps>
  <Step title="Send the invitation">
    In **Settings → Organization**, open the invite dialog, enter the person's email address, and choose the [role](/roles) they'll start with. tinyanalytics emails them an invitation link.
  </Step>
...
A pending invitation is one that's been sent but not yet accepted. Owners and admins can revoke any pending invitation from the invitations list, which invalidates its link. To remove someone who has *already* accepted, remove them from the members table instead — see [Organizations & members](/organizations).
...
<AccordionGroup>
  <Accordion title="How do I cancel a tinyanalytics invitation I already sent?">
    Revoke it from the **pending invitations** list, which invalidates its link. Owners and admins can revoke any invitation that hasn't been accepted yet. To remove someone who has *already* accepted, remove them from the members table instead — see [organizations & members](/organizations).
  </Accordion>
  <Accordion title="Can a member invite people to the organization?">
    No. Only **owners** and **admins** can send invitations and revoke pending ones. Members can't invite people. See [roles & permissions](/roles) for what each role can do.
  </Accordion>
