...
- **Members** — the people who can access the organization's sites, each with a [role](/roles).
- **Teams** — optional groups that grant members access to a subset of sites. See [Teams & site access](/teams).

## How do I add members to my organization?

You add members by **email invitation**. As an owner or admin, invite someone by their email address; they receive a link to join, and once they accept they become a member with the role you chose. See [Invitations](/invitations) for the full flow.
...
- Every member has one of three roles — owner, admin, or member. See [Roles & permissions](/roles).
...
If you run more than one organization, you can move a site — with all its history — from one to another yourself, from the site's own **Settings → General**. You need to be an owner or admin of both organizations, and moving a site clears its team-access grants. See [site settings](/site-settings#move-a-site-to-another-organization) for the steps.
...
<AccordionGroup>
  <Accordion title="What's the difference between an organization and a team in tinyanalytics?">
    An **organization** is the container for your sites and teammates — every site belongs to one, and every teammate is a member of it. A **team** is an optional group inside an organization that grants its members access to a subset of those sites. See [teams & site access](/teams).
  </Accordion>
