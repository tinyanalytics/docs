...
<Info>
  **Crawling is not citation.** This report shows that an AI crawler *read* a page — the step that comes before you're cited in an AI answer. It cannot tell you whether a crawl produced a citation, and no user-agent or referrer can: that needs the AI platforms' own data. To see the *other* end of the funnel — humans who clicked through from an AI answer — use the [AI traffic report](/ai-referral-traffic-analytics), which now also summarizes AI crawlers by operator and shows a per-page **Crawled** count (AI-crawler requests) beside the pages AI sends people to — as correlated facts, never a ratio.
</Info>
