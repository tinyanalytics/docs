...
**Phase 6 — API reference & Resources** — 🚧 API tab done (2026-07-17)
...
- ⬜ **Resources** tab (next wave): Metric definitions (glossary), How cookieless identity works, How bot detection works, How traffic is classified, How your data is handled (trust-level, no operator internals), Privacy & GDPR, tinyanalytics vs GA/Plausible/Umami, Use these docs with AI, Changelog.

**Phase 7 — AI-native activation & polish**
- Turn on assistant + starter questions + deflection; set up agent-in-Slack + automations; SEO/OG pass; link audit; scannability review.
