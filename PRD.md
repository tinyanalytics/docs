...
**Phase 6 — API reference & Resources**
- API tab (tracking, identify, read, SQL, keys, playground); Resources (definitions, cookieless identity, bot detection, channels, data handling, privacy, comparison, "Use these docs with AI").
