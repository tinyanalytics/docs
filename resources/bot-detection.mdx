...
Filtered bots don't disappear silently — the [bots & AI crawlers report](/bots) shows the automated traffic that was kept out of your human analytics, including which AI crawlers are visiting your site. Detected AI-assistant *referrals* (a real person arriving from an AI answer) are a separate signal, covered in [AI traffic](/ai-traffic).

## Related

<Columns cols={2}>
  <Card title="Bots & AI crawlers" icon="robot" href="/bots">
