...
| **AI traffic (AI sessions)** | The number of sessions that *entered* from an [AI assistant](/guides/ai-traffic) — a visitor who clicked through from ChatGPT, Perplexity, Gemini, Claude, Copilot, and similar. Each session is counted once, by the assistant it arrived from. |
