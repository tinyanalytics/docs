...
Use a least-privilege Stripe restricted key — never a secret key. See [Connect Stripe revenue](/stripe-revenue) for permissions, setup, attribution, and verification.
...
<Columns cols={2}>
  ...
  <Card title="Connect Stripe" icon="credit-card" href="/stripe-revenue">
