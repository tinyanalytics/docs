...
<Note>
  The timeline view loads sessions in pages and caps very busy ranges; when a range is truncated, the scrubber shows a notice. For an exhaustive list, use the [Sessions](/sessions) report with a location filter.
</Note>
