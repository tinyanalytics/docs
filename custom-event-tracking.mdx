...
<Note>
  Many interactions are already captured for you — outbound links, downloads, button clicks, copies, and form submissions. Use custom events for actions that are specific to your app and that auto-capture can't infer. See [auto-capture](/configure-tinyanalytics-tracking-script#turn-auto-capture-on-or-off).
</Note>
