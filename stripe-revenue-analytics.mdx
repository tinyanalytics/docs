...
description: "Connect Stripe to tinyanalytics with a restricted key, measure verified charges, refunds, and lost disputes, and attribute each payment to the channel that won the customer."
icon: "credit-card"
---
