...
When no replays appear, start with the built-in diagnosis: open **Settings → Apps → Session
...
<Steps>
  <Step title="Is session replay enabled for the site?">
    [Session replay](/session-replay) is off by default. In **Settings → Apps → Session
