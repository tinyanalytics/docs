...
<AccordionGroup>
  ...
  <Accordion title="Can people who see the embed edit my analytics?">
    No. The embed shows the same read-only dashboard as a [public dashboard](/guides/public-dashboards). Viewers can browse reports and change the date range, but can't edit anything or reach your settings or account.
  </Accordion>
</AccordionGroup>
