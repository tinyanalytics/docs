...
<Steps>
  <Step title="Visit a page on your site">
    Open a published page that includes the tracking snippet. Use a normal browser tab, not a preview or a private window with tracking blocked.
  </Step>
...
<AccordionGroup>
  <Accordion title="I don't see any data at all" icon="circle-xmark">
    ...
    - **The snippet isn't on the live page.** View the page source of your published site and confirm the `<script … data-site-id="…">` tag is in the `<head>`. Drafts and previews don't count.
