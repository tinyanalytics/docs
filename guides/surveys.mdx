...
{/* TODO: add screenshot of the surveys page */}

## Turn surveys on for your site

Surveys are **off by default** for a new site. Enable surveys for the site first — until you do, drafting a survey alone won't put anything in front of visitors, and the widget code never loads. This keeps the tracker lean for sites that don't use surveys.
...
The survey's results page shows, over its lifetime:
