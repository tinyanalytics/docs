...
<Check>
  The install is working when your own visit appears in the dashboard within a few seconds. If it doesn't, see [verify your setup](/guides/verify-your-setup).
</Check>
...
<AccordionGroup>
  <Accordion title="Does the tinyanalytics tracking script slow down my site?">
    No. The tinyanalytics tracking script is under **6 KB** gzipped and loads with `defer`, so the browser runs it after the HTML has parsed. It never blocks your page from loading.
  </Accordion>
