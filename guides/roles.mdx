...
<AccordionGroup>
  ...
  <Accordion title="What can a plain member do without admin rights?">
    A **member** can view analytics for the sites they have access to and save their own personal [segments](/guides/segments) and [cohorts](/guides/cohorts). Anything that creates or changes shared data — sites, site settings, goals, funnels, annotations, shared segments and cohorts, members, teams, imports — needs an owner or admin.
  </Accordion>
  ...
  <Accordion title="How do I give someone access to only one site?">
    Use [teams](/guides/teams). Create a team, grant it the sites that person should see, add them to it, and mark them **restricted**. A restricted member sees only their teams' sites. Owners and admins can't be restricted — they always have access to every site.
  </Accordion>
</AccordionGroup>
