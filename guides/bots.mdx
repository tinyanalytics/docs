...
<Note>
  Period comparison isn't available on this report. The date-range picker on the Bots & AI crawlers page has no compare option — see [compare periods](/guides/compare).
</Note>
