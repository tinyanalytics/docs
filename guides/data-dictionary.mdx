...
description: "Browse every event, property, and user trait your site has collected in tinyanalytics — with inferred types, example values, and volume — and mark the canonical ones verified."
icon: "book"
---
