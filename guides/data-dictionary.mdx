...
description: "Browse every event, property, and user trait your tinyanalytics site has collected — with inferred types, example values, and volume — and mark the canonical ones as verified for your team."
icon: "book"
---
...
{/* TODO: screenshot of the data dictionary */}
...
| --- | --- | --- |
| **Event** | A custom event name | Your [custom events](/guides/custom-events) |
| **Event property** | A key inside a custom event's properties | The properties you send with events |
| **User trait** | A trait set on an identified user | [`identify()`](/guides/identify-users) |
