...
<AccordionGroup>
  <Accordion title="How do I remove a filter in tinyanalytics?">
    Click the same row again. If you filtered by clicking a value in a breakdown, table, or map — a page, a referrer, a country — clicking it a second time removes that filter. Filters you built with the filter control are removed from the control itself.
  </Accordion>
