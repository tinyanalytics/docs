...
<AccordionGroup>
  ...
  <Accordion title="How accurate is retention for anonymous visitors?">
    It's a close estimate. tinyanalytics recognizes returning visitors cookielessly, which works well for anonymous traffic but isn't exact. To make retention exact for signed-in people, [identify users](/guides/identify-users) so their visits are tied to a stable ID.
  </Accordion>
</AccordionGroup>
