...
<Note>
  The report's date range follows your dashboard time zone, so it respects your site's [reporting timezone](/guides/site-settings#which-timezone-are-my-reports-based-on) when one is set.
</Note>
