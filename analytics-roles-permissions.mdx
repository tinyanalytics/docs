...
Anything that creates or changes shared data requires the **owner** or **admin** role — that's the "requires an admin" note you'll see throughout these guides. A plain member can always view the reports they have access to and save their own personal [segments](/saved-analytics-segments) and [cohorts](/behavioral-cohort-analysis).
