...
preview of your page, from your existing [tracking snippet](/install-tinyanalytics-tracking-script)
...
[API playground](/api-reference/api-playground): `GET /api/sites/:id/heatmap/pages` (which pages have
click data), `GET /api/sites/:id/heatmap/clicks` (binned intensity points for one page, band, and
click type), and `GET /api/sites/:id/heatmap/scroll` (cumulative scroll reach per 10% band).
