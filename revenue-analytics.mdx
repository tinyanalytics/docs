...
<Tabs>
  <Tab title="Client events">
    ...
    Send the event from the browser only after your app confirms the purchase. Keep the event call in
    the same client-side success path that renders the receipt or confirmation state.
  </Tab>
  <Tab title="Stripe">
...
<Columns cols={2}>
  ...
  <Card title="Browser event API" icon="browser" href="/api-reference/track-events-api">
    Send revenue events from client-side code.
  </Card>
