---
title: "Embed an Analytics Dashboard"
sidebarTitle: "Embed dashboard"
...
<Note>
  The embed shows the same read-only dashboard as a [public dashboard](/public-analytics-dashboards) — viewers can browse reports and change the date range, but can't edit anything or reach your settings or account.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Can people who see the embed edit my analytics?">
    No. The embed shows the same read-only dashboard as a [public dashboard](/public-analytics-dashboards). Viewers can browse reports and change the date range, but can't edit anything or reach your settings or account.
  </Accordion>
</AccordionGroup>
...
<Columns cols={2}>
  ...
  <Card title="Live-visitors widget" icon="chart-simple" href="/live-visitor-count-widget">
